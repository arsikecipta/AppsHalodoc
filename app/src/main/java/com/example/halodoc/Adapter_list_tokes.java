...
public class Adapter_list_tokes extends RecyclerView.Adapter<Adapter_list_tokes.ViewHolder> {

    private Context context;
    ArrayList<Model_list_tokes> modelListTokes;
    public Adapter_list_tokes (ArrayList<Model_list_tokes> modelListTokes,toko_kesehatan activity){
    ...
    @Override
    public void onBindViewHolder(@NonNull Adapter_list_tokes.ViewHolder holder, int position) {
