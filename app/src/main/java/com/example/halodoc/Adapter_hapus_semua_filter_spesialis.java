...
public class Adapter_hapus_semua_filter_spesialis extends RecyclerView.Adapter<Adapter_hapus_semua_filter_spesialis.ViewHolder> {

    private Context context;
    ArrayList<Model_list_dokter> modelListDokter;
    public Adapter_hapus_semua_filter_spesialis (ArrayList<Model_list_dokter> modelListDokter,Hapus_semua_filter_spesialisasi activity){
    ...
    @Override
    public void onBindViewHolder(@NonNull Adapter_hapus_semua_filter_spesialis.ViewHolder holder, int position) {
