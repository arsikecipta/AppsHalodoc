...
public class lihat_semua_tokes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Model_list_tokes> modellistokes = new ArrayList<>();
        modellistokes.add(new Model_list_tokes(
                "Covid-19",
        ...
        modellistokes.add(new Model_list_tokes("Batuk dan Flu",
        ...
        modellistokes.add(new Model_list_tokes("Demam",
        ...
        modellistokes.add(new Model_list_tokes("Watsons Deals",
        ...
        modellistokes.add(new Model_list_tokes("Vitamin & Suplemen",
        ...
        modellistokes.add(new Model_list_tokes("Diabetes",
        ...
        modellistokes.add(new Model_list_tokes("Saluran Pencernaan",
        ...
        modellistokes.add(new Model_list_tokes("Hipertensi",
        ...
        modellistokes.add(new Model_list_tokes("Minyak Angin & Balsam",
        ...
        modellistokes.add(new Model_list_tokes("Alat Bantu Dengar",
        ...
        modellistokes.add(new Model_list_tokes("Lainya",
                "Pro-Liver","Per-Box","Rp 38.000",R.drawable.tekes1,
                "Redoxon","Per-Box","Rp 25.000",R.drawable.tekes2,
                "Lansoprazole","Per-Box","Rp 60.000",R.drawable.tekes3,
                "Prospan","Per-Botol","Rp 35.000",R.drawable.tekes4,
...
//        modellistokes.add(new Model_list_tokes("Lainya","Propolis","Per-Botol","Rp 200.000",R.drawable.indonesia));
        ...
        Adapter_lihat_semua_tokes adapter_divider = new Adapter_lihat_semua_tokes (modellistokes, lihat_semua_tokes.this);
