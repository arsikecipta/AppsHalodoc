...
public class LihatSemuaRS extends AppCompatActivity {
    ...
    private void ListRs() {
        ...
        modelListRs.add(new model_list_rs(R.drawable.axeldental,
                ...
                "Bleaching gigi","Scalling","Rp5000.000", "Rp300.000", R.drawable.poligigi,R.drawable.scalling,"Pinang, Tangerang","Axel Dental merupakan klinik yang berada dibawah naungan CV Tri Anugra dan didirikan untuk memberikan pelayanan terbaik untuk kesehatan gigi bagi keluarga indonesia dengan berkerja sama dengan para dokter gigi profesional."));;
        ...
        modelListRs.add(new model_list_rs(R.drawable.rsprimaya,
                ...
                "PCR Drive Thru","Tes Rapid, Rapid Basic","Rp950.000","Rp950.000", R.drawable.drivethru,R.drawable.swab,"Pinang, Tangerang","Unit bisnis Laboratorium Klinik Kimia Far,a donila sekal tahun 2003 dibawah PT. Kimia Farma (persero) Tbk. sebagai Healthcare company."));
