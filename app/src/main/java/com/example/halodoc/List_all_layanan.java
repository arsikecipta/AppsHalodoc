...
public class List_all_layanan extends AppCompatActivity {
    ...
    private void ListLayanan() {
        ...
        model_all_layanan layanan6 = new model_all_layanan( "Poliklinik Anak","Vaksinasi Anak Campak","Vaksinasi Anak DTP Hib Polio Hep B (Hexamim)","Vaksinasi Anak Hepatitis A (Havrix 720 Junior)",R.drawable.polianak ,
                "Poliklinik Anak berfokus pada kesehatan anak yang dimulai sejak mereka dilahirkan hingga 18 tahun. Tidak hanya berfokus pada aspek penunjang yang dibutuhkan oleh anak, namun juga gangguan kesehatan seperti penyakit, kelainan, alergi dll yang dapati menganggu tumbuh kembang anak.",
                ...
                "Rp350.000","Rp1.1000.000","Rp550.000");
