...
public class model_artikel {
    private int image;
    private String title_artikel, topik_artikel, dokter_artikel;

    public model_artikel(int image, String title_artikel, String topik_artikel,String dokter_artikel) {
        this.image = image;
