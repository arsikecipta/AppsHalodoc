...
public class Adapter_lihat_semua_dokter_filter extends RecyclerView.Adapter<Adapter_lihat_semua_dokter_filter.ViewHolder> {

    private Context context;
    ArrayList<Model_list_dokter> modelListDokter;
    public Adapter_lihat_semua_dokter_filter (ArrayList<Model_list_dokter> modelListDokter,Lihat_semua_dokter_filter activity){
    ...
    @Override
    public void onBindViewHolder(@NonNull Adapter_lihat_semua_dokter_filter.ViewHolder holder, int position) {
