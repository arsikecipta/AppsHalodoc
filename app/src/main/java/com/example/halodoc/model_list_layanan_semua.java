...
public class model_list_layanan_semua {
    ...
    public model_list_layanan_semua(String nama_layanan, String jenis_layanan, String nama_rs, String alamat_rs, String biaya_layanan, int image_layanan,String penjelasan_layanan, String nama_pasien) {
