...
public class BerandaFragmentNew extends Fragment {
    public CardView card1;
    public CardView card2;
    public CardView card3;
    private ViewPager viewPager;
    private ViewPager viewPager_topik;
    TextView et_namalengkap, masuk_daftar, welcome_name;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_beranda_new, container, false);
        masuk_daftar=v.findViewById(R.id.masuk_daftar_new);
        Intent intent = getActivity().getIntent();
        //Nama regis
        String namalengkap =intent.getExtras().getString("NamaLengkap");
        masuk_daftar.setText(namalengkap);

        welcome_name=v.findViewById(R.id.nama_regis);
        welcome_name.setText(namalengkap);


        masuk_daftar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent= new Intent(BerandaFragmentNew.this.getActivity(), LengkapiProfil.class);
        ...
        btn_see_all.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent= new Intent(BerandaFragmentNew.this.getActivity(), Lihat_semua_artikel.class);
                startActivity(intent);
            }
        });
        ...
        card3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("NamaLengkap",masuk_daftar.getText());
                startActivity(intent);
            }
        });
        ...
        recyclerViewArtikel.setLayoutManager(new LinearLayoutManager(BerandaFragmentNew.this.getActivity()));
