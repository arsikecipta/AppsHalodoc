...
public class Adapter_chat_dengan_dokter extends RecyclerView.Adapter<Adapter_chat_dengan_dokter.ViewHolder> {

    private Context context;
    ArrayList<Model_list_dokter> modelListDokter;
    public Adapter_chat_dengan_dokter(ArrayList<Model_list_dokter> modelListDokter,chat_dengan_dokter activity){
    ...
    @Override
    public void onBindViewHolder(@NonNull Adapter_chat_dengan_dokter.ViewHolder holder, int position) {
